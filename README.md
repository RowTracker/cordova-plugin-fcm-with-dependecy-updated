...
|ANDROID_GOOGLE_SERVICES_VERSION|4.3.4|Native Google Services SDK version.| -- ATW this property has been removed
...
npm install -g cordova@latest # Version 9 or higher required
npm uninstall @ionic-native/fcm # Ionic support is included and conflicts with @ionic-native's implementation.
#ATW was  --variable IOS_FIREBASE_MESSAGING_VERSION="~> 7.4.0"
cordova plugin add cordova-plugin-fcm-with-dependecy-updated \
  ...
  --variable IOS_FIREBASE_MESSAGING_VERSION="10.29.0"
```
...
ionic cordova plugin add cordova-plugin-fcm-with-dependecy-updated \
  --variable ANDROID_DEFAULT_NOTIFICATION_ICON="@mipmap/ic_launcher" \
  --variable ANDROID_FIREBASE_BOM_VERSION="33.1.16" \
  --variable ANDROID_GOOGLE_SERVICES_VERSION="4.4.3" \
  --variable ANDROID_GRADLE_TOOLS_VERSION="4.13.0" \
  --variable IOS_FIREBASE_MESSAGING_VERSION="11.15.0"
```
